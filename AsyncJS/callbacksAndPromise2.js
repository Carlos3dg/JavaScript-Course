...
/*----- PROMISES ------*/
/* Promises are used when we get external information from an API or something similar, these are a optional way to make asyncronous procces and */
...
const promise = new Promise(function(resolve, reject){
    ...
    //This functions allow the promise to change his status
    setTimeout(function(){
